...
// funkcija za ajax učitavanje stranice
function ucitaj(naziv)
{
	var ajax = new XMLHttpRequest();
    ajax.onreadystatechange = function() {
	if (ajax.readyState == 4 && ajax.status == 200)
		if(naziv == "index.html") document.getElementById("citavo").innerHTML = ajax.responseText;
		else document.getElementById("container").innerHTML = ajax.responseText;
	if (ajax.readyState == 4 && ajax.status == 404)
		document.getElementById("container").innerHTML = "Greska: nepoznat URL";
	
	if (naziv == "Pocetna.html") document.getElementById("tab1").className = "selektovan";
	else document.getElementById("tab1").className = "";
	if (naziv == "O_nama_Historijat.html" || naziv == "O_nama_Slike.html") document.getElementById("tab2").className = "selektovan";
	else document.getElementById("tab2").className = "";	
	if (naziv == "O_nama_Historijat.html") document.getElementById("tab3").className = "selektovan";
	else document.getElementById("tab3").className = "";
	if (naziv == "O_nama_Slike.html") document.getElementById("tab4").className = "selektovan";
	else document.getElementById("tab4").className = "";
	if (naziv == "IPhO_i_RMPh.html") document.getElementById("tab5").className = "selektovan";
	else document.getElementById("tab5").className = "";
	if (naziv == "Takmicenja.html") document.getElementById("tab6").className = "selektovan";
	else document.getElementById("tab6").className = "";
	if (naziv == "Kontakt.html") document.getElementById("tab7").className = "selektovan";
	else document.getElementById("tab7").className = "";
	}
